...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Gabriel_evak_exo_vin_037e3bf764772da85444_20220321153137_archive.zip';
	const ARCHIVE_SIZE		 = '86099866';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '037e3bf-21153137';
    const SECONDARY_PACKAGE_HASH = '293b8a3-21153137';
	const VERSION			 = '1.4.4';
