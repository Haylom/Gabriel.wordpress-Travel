...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Gabriel_Exo1_cceca3d25113bd5d2079_20220310112401_archive.zip';
	const ARCHIVE_SIZE		 = '24007731';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'cceca3d-10112401';
    const SECONDARY_PACKAGE_HASH = '3b40bd3-10112401';
	const VERSION			 = '1.4.4';
